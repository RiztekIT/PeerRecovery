...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-home-home-module"], {
  ...
  function srcAppPagesHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _emotions_emotions_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    HomePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_5__["HomePageRoutingModule"], _emotions_emotions_module__WEBPACK_IMPORTED_MODULE_8__["EmotionsPageModule"]],
  ...
  function srcAppPagesHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _emotions_emotions_page__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ../emotions/emotions.page */
    "./src/app/pages/emotions/emotions.page.ts"); //import { FCM } from '@ionic-native/fcm/ngx';
    //import { ModalPage } from '../modal/modal.page';


    var HomePage = /*#__PURE__*/function () {
      function HomePage(util, authSVC, geolocation, nativeGeocoder, platform, zone, alertController, nav, router, modalCtr, appointmentService, http, backgroundGeolocation, foregroundService, backgroundMode, http2, sanitizer, iab, modalController) {
      ...
      _createClass(HomePage, [{
        ...
        value: function startBackgroundGeolocation() {
          ...
          this.backgroundGeolocation.configure(config).then(function () {
            _this41.backgroundGeolocation.on(_ionic_native_background_geolocation_ngx__WEBPACK_IMPORTED_MODULE_10__["BackgroundGeolocationEvents"].location).subscribe(function (location) {
              ...
              _this41.nowLocation.lat = location.latitude;
              _this41.nowLocation.lng = location.longitude;
        ...
        value: function initializeApp() {
          ...
          this.platform.ready().then(function () {
            ...
            _this47.getAppointments();

            _this47.getEmotion(); //FCM.getToken()
        ...
        key: "openProfileDataSheet",
        value: function openProfileDataSheet() {
          this.router.navigate(['profiledatasheet']);
        }
      }, {
        key: "openResourcePDF",
        value: function openResourcePDF() {
          this.router.navigate(['resource-dir']);
        }
      }, {
        key: "openEmotions",
        value: function openEmotions() {
        ...
        key: "getEmotion",
        value: function getEmotion() {
          var _this54 = this;

          this.emotion = '';
          this.util.getEmotion(this.user.uid).on('value', function (resp) {
            _this54.emotion = resp.val();
          });
        }
      }]);
