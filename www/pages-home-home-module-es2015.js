...
let HomePage = class HomePage {
    constructor(util, authSVC, geolocation, nativeGeocoder, platform, zone, alertController, nav, router, modalCtr, appointmentService, http, backgroundGeolocation, foregroundService, backgroundMode, fcm) {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            this.fcm.getToken().then(token => {
                ...
                this.authSVC.sendToken(this.authSVC.usersign, res);
            });
            //this.startBackgroundGeolocation()
            //this.put(1,1);
            //this.backgroundGeolocation.start();
