...
let HomePage = class HomePage {
    constructor(util, authSVC, geolocation, nativeGeocoder, platform, zone, alertController, nav, router, modalCtr, appointmentService, http, backgroundGeolocation, foregroundService, backgroundMode, http2) {
