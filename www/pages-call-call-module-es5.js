    ...
    var CallPage = /*#__PURE__*/function () {
      ...
      _createClass(CallPage, [{
        ...
        value: function openCam() {
          console.log('CAMARA'); //this.openCamera()
        ...
        value: function startCamera() {
          var div = document.getElementById('video'); // camera options (Size and location). In the following example, the preview uses the rear camera and display the preview in the back of the webview
