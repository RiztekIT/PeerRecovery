...
function _createClass(e, t, o) { return t && _defineProperties(e.prototype, t), o && _defineProperties(e, o), e }(window.webpackJsonp = window.webpackJsonp || []).push([
    [32], {
        eLfv: function(e, t, o) {
            "use strict";
                    ...
                    return _createClass(e, [{ key: "componentWillLoad", value: function() { this.emitStyle() } }, { key: "checkedChanged", value: function(e) { this.ionChange.emit({ checked: e, value: this.value }), this.emitStyle() } }, { key: "disabledChanged", value: function() { this.emitStyle() } }, { key: "emitStyle", value: function() { this.ionStyle.emit({ "checkbox-checked": this.checked, "interactive-disabled": this.disabled }) } }, { key: "setFocus", value: function() { this.buttonEl && this.buttonEl.focus() } }, {
                        ...
                        value: function() {
                            var e, t = this,
                                ...
                                u = Object(i.b)(this),
                                m = Object(n.f)(l);
                            m && (m.id = k), Object(n.a)(!0, l, this.name, h ? b : "", s);
                            var p = a ? Object(r.j)("path", { d: "M6 12L18 12" }) : Object(r.j)("path", { d: "M5.9,12.5l3.8,3.8l8.8-8.8" });
                            return "md" === u && (p = a ? Object(r.j)("path", { d: "M2 12H22" }) : Object(r.j)("path", { d: "M1.73,12.91 8.1,19.28 22.79,4.59" })), Object(r.j)(r.b, { onClick: this.onClick, role: "checkbox", "aria-disabled": s ? "true" : null, "aria-checked": "".concat(h), "aria-labelledby": k, class: Object.assign(Object.assign({}, Object(c.a)(d)), (e = {}, _defineProperty(e, u, !0), _defineProperty(e, "in-item", Object(c.c)("ion-item", l)), _defineProperty(e, "checkbox-checked", h), _defineProperty(e, "checkbox-disabled", s), _defineProperty(e, "checkbox-indeterminate", a), _defineProperty(e, "interactive", !0), e)) }, Object(r.j)("svg", { class: "checkbox-icon", viewBox: "0 0 24 24" }, p), Object(r.j)("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: function(e) { return t.buttonEl = e } }))
                        }
                    }, { key: "el", get: function() { return Object(r.g)(this) } }], [{ key: "watchers", get: function() { return { checked: ["checkedChanged"], disabled: ["disabledChanged"] } } }]), e
                }(),
                s = 0;
