...
function asyncGeneratorStep(t, e, n, i, o, r, a) {
    ...
    s.done ? e(d) : Promise.resolve(d).then(i, o)
}
...
function _createClass(t, e, n) { return e && _defineProperties(t.prototype, e), n && _defineProperties(t, n), t }(window.webpackJsonp = window.webpackJsonp || []).push([
    [89], {
        WbT0: function(t, e, n) {
            "use strict";
            n.r(e), n.d(e, "ion_toggle", (function() { return d }));
            var i = n("Wbmy"),
                o = n("8XIS"),
                r = n("pM1R"),
                a = n("KwJk"),
                ...
                d = function() {
                    function t(e) {
                        var n = this;
                        _classCallCheck(this, t), Object(i.l)(this, e), this.inputId = "ion-tg-".concat(g++), this.lastDrag = 0, this.activated = !1, this.name = this.inputId, this.checked = !1, this.disabled = !1, this.value = "on", this.onClick = function() { n.lastDrag + 300 < Date.now() && (n.checked = !n.checked) }, this.onFocus = function() { n.ionFocus.emit() }, this.onBlur = function() { n.ionBlur.emit() }, this.ionChange = Object(i.f)(this, "ionChange", 7), this.ionFocus = Object(i.f)(this, "ionFocus", 7), this.ionBlur = Object(i.f)(this, "ionBlur", 7), this.ionStyle = Object(i.f)(this, "ionStyle", 7)
                    }
                    var e;
                    return _createClass(t, [{ key: "checkedChanged", value: function(t) { this.ionChange.emit({ checked: t, value: this.value }) } }, { key: "disabledChanged", value: function() { this.emitStyle(), this.gesture && this.gesture.enable(!this.disabled) } }, {
                        ...
                        value: (e = _asyncToGenerator(regeneratorRuntime.mark((function t() {
                            ...
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return t.next = 2, Promise.resolve().then(n.bind(null, "t265"));
                                    case 2:
                                        this.gesture = t.sent.createGesture({ el: this.el, gestureName: "toggle", gesturePriority: 100, threshold: 5, passive: !1, onStart: function() { return e.onStart() }, onMove: function(t) { return e.onMove(t) }, onEnd: function(t) { return e.onEnd(t) } }), this.disabledChanged();
                                    case 4:
                                    case "end":
                                        return t.stop()
                                }
                    ...
                    }, { key: "disconnectedCallback", value: function() { this.gesture && (this.gesture.destroy(), this.gesture = void 0) } }, { key: "componentWillLoad", value: function() { this.emitStyle() } }, { key: "emitStyle", value: function() { this.ionStyle.emit({ "interactive-disabled": this.disabled }) } }, { key: "onStart", value: function() { this.activated = !0, this.setFocus() } }, { key: "onMove", value: function(t) { c(document, this.checked, t.deltaX, -10) && (this.checked = !this.checked, Object(s.d)()) } }, { key: "onEnd", value: function(t) { this.activated = !1, this.lastDrag = Date.now(), t.event.preventDefault(), t.event.stopImmediatePropagation() } }, { key: "getValue", value: function() { return this.value || "" } }, { key: "setFocus", value: function() { this.buttonEl && this.buttonEl.focus() } }, {
                        key: "render",
                        value: function() {
                            var t, e = this,
                                n = this.inputId,
