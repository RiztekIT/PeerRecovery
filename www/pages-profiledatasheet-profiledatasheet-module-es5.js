  ...
  function srcAppPagesProfiledatasheetProfiledatasheetPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfiledatasheetPage = /*#__PURE__*/function () {
      ...
      _createClass(ProfiledatasheetPage, [{
        ...
        key: "getProfileDS",
        value: function getProfileDS() {
          var _this = this;

          this.profileSVC.getProfileDS(this.user.uid).once('value').then(function (resp) {
            resp.forEach(function (r) {
              _this.profileDS = r.val();
              _this.profileDS.appkey = r.key;
              _this.ver = true;
              _this.name = _this.profileDS.name, _this.age = _this.profileDS.age, _this.sobrietyDate = _this.profileDS.sobrietyDate, _this.phaseDWI = _this.profileDS.phaseDWI, _this.Occupation = _this.profileDS.Occupation, _this.Employeer = _this.profileDS.Employeer, _this.job = _this.profileDS.job, _this.probationKnow = _this.profileDS.probationKnow, _this.supportiveJob = _this.profileDS.supportiveJob, _this.status = _this.profileDS.status, _this.nameSpouse = _this.profileDS.nameSpouse, _this.children = _this.profileDS.children, _this.liveswithyou = _this.profileDS.liveswithyou, _this.treatmeant = _this.profileDS.treatmeant, _this.phaseTreatmeant = _this.profileDS.phaseTreatmeant, _this.soberGroup = _this.profileDS.soberGroup, _this.sponsorAA = _this.profileDS.sponsorAA, _this.steps = _this.profileDS.steps, _this.otherpartDWI = _this.profileDS.otherpartDWI, _this.otherIncentive = _this.profileDS.otherIncentive, _this.othersourceStress = _this.profileDS.othersourceStress, _this.funThings = _this.profileDS.funThings, _this.mostSupportPerson = _this.profileDS.mostSupportPerson, _this.driverLicenceSuspend = _this.profileDS.driverLicenceSuspend, _this.occupationalDL = _this.profileDS.occupationalDL, _this.DWICourtProgram = _this.profileDS.DWICourtProgram, _this.favoriteIncentive = _this.profileDS.favoriteIncentive, _this.sourceStress = _this.profileDS.sourceStress, _this.detectionDevice = _this.profileDS.detectionDevice, _this.done = _this.profileDS.done;
              _this.appkey = _this.profileDS.appkey;
            });
