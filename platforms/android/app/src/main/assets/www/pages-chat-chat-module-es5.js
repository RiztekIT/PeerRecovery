...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-chat-chat-module"], {
  ...
  function srcAppPagesChatChatPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ChatPage = /*#__PURE__*/function () {
      function ChatPage(nav, route, router, firebaseAuthService, chatService, http, http2) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {
          if (params && params.data) {
            ...
            _this.parametros = true;
            _this.chatService.keymessage = data.key;
            _this.chatUser = data.chatuser;
          }
        });
      }
      ...
      _createClass(ChatPage, [{
        ...
        value: function sendMessage() {
          ...
          this.message = '';
          this.chatService.getTokenID(this.chatUser.uid).once('value', function (token) {
            console.log(token.val(), 'USERS');
            /* this.sendLocation(this.currentPos,token.val()) */

            _this2.sendMessageNoti(_this2.message, _this2.chatService.keymessage, token.val(), _this2.chatUser);
          });
        }
      }, {
        key: "sendMessageNoti",
        value: function sendMessageNoti(message, keymessage, user, chatuser) {
          var data = {
            key: keymessage,
            m: message,
            user: chatuser
        ...
        value: function scrollToBottom() {
          this.content.scrollToBottom(300); //document.getElementById('chatcontent').scrollTo();
        }
      }, {
        key: "eventoMensaje",
        value: function eventoMensaje(tecla) {
          console.log(tecla);
          ...
          this.chatService.getMessages().orderByChild('timestamp').on('value', function (resp) {
            ...
            resp.forEach(function (childSnapshot) {
              ...
              _this3.chatService.getUser(m.sender).on('value', function (resp) {
                ...
                _this3.chatMessages = _this3.messages;
              });
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('chatcontent', {
      "static": false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonContent"])], ChatPage.prototype, "content", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], src_app_services_chat_service__WEBPACK_IMPORTED_MODULE_5__["ChatService"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_6__["HTTP"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClient"]])], ChatPage);
    /***/
  }
}]);
