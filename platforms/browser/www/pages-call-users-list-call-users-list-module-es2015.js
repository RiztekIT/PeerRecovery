...
/* harmony import */ var src_app_services_videocall_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/videocall.service */ "./src/app/services/videocall.service.ts");
...
let CallUsersListPage = class CallUsersListPage {
    constructor(nav, router, firebaseAuthService, chatService, cameraPreview, videocallSVC) {
        this.nav = nav;
        this.router = router;
        ...
        this.videocallSVC.getUsers().on('value', resp => {
            ...
            resp.forEach((childSnapshot) => {
                ...
                if (item.key != this.user.uid) {
                    console.log(item);
                    console.log(this.user);
                    this.videocallSVC.getRel(this.user, item.key).once('value', (resp) => {
                        console.log(resp);
...
CallUsersListPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"],
        ...
        src_app_services_videocall_service__WEBPACK_IMPORTED_MODULE_7__["VideocallService"]])
], CallUsersListPage);
