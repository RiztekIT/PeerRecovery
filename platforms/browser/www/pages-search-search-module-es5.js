      ...
      _createClass(AgmOverlay, [{
        ...
        value: function ngAfterViewInit() {
          ...
          this.load().then(function () {
            _this82.onChanges = _this82.onChangesOverride;
          });
        }
      }, {
        key: "ngAfterContentInit",
        value: function ngAfterContentInit() {
          ...
          this.infoWindow.changes.subscribe(function () {
            return _this83.handleInfoWindowUpdate();
          });
        }
      }, {
        key: "ngOnChanges",
        ...
        value: function handleInfoWindowUpdate() {
          ...
          this.infoWindow.forEach(function (iWin) {
            iWin.hostMarker = _this85.overlayView;
          });
        }
      }, {
        key: "load",
        value: function load() {
          ...
          return this._mapsWrapper.getNativeMap().then(function (map) {
            var overlay = _this86.getOverlay(map);

            _this86._markerManager.addMarker(overlay);

            _this86._addEventListeners();

            return _this86._markerManager.getNativeMarker(overlay);
          }).then(function (nativeMarker) {
            var setMap = nativeMarker.setMap;

            if (nativeMarker['map']) {
              _this86.overlayView.setMap(nativeMarker['map']);
            }

            nativeMarker.setMap = function (map) {
              setMap.call(nativeMarker, map);

              if (_this86.overlayView) {
                _this86.overlayView.setMap(map);
              }
            };
          });
        }
        ...
        value: function getOverlay(map) {
          ...
          var restore = function restore(div) {
            _this87.template.nativeElement.appendChild(div);
          };
  ...
  function srcAppPagesSearchSearchPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SearchPage = /*#__PURE__*/function () {
      ...
      _createClass(SearchPage, [{
        ...
        key: "goToHospitalDetail",
        value: function goToHospitalDetail() {}
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewChild"])("search", {
      "static": true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], SearchPage.prototype, "search", void 0);
    SearchPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      selector: "app-search",
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_util_service__WEBPACK_IMPORTED_MODULE_1__["UtilService"]])], SearchPage);
    /***/
  }
}]);
