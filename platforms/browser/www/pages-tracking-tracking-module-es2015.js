...
/* harmony import */ var _tracking_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tracking.page */ "./src/app/pages/tracking/tracking.page.ts");
...
const routes = [
    ...
    {
        path: 'panics',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./panics/panics.module */ "./src/app/pages/tracking/panics/panics.module.ts")).then(m => m.PanicsPageModule)
    }
];
let TrackingPageRoutingModule = class TrackingPageRoutingModule {
};
TrackingPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _tracking_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tracking-routing.module */ "./src/app/pages/tracking/tracking-routing.module.ts");
...
/* harmony import */ var _panics_panics_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./panics/panics.module */ "./src/app/pages/tracking/panics/panics.module.ts");
...
TrackingPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _panics_panics_module__WEBPACK_IMPORTED_MODULE_9__["PanicsPageModule"]
        ],
...
/* harmony import */ var _panics_panics_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./panics/panics.page */ "./src/app/pages/tracking/panics/panics.page.ts");
...
let TrackingPage = class TrackingPage {
    constructor(util, alertController, authSVC, trackingSVC, http, route, loadingCtrl, toastCtrl, modalController, router) {
        this.util = util;
    ...
    onMarkerClick(params) {
        let marker = params[1];
        let iconData = marker.get('iconData');
...
], TrackingPage.prototype, "search", void 0);
