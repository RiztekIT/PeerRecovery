...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-starter-starter-module"], {
  ...
  function srcAppPagesStarterStarterModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _starter_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./starter-routing.module */
    "./src/app/pages/starter/starter-routing.module.ts");
    /* harmony import */


    var _starter_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./starter.page */
    "./src/app/pages/starter/starter.page.ts");
    /* harmony import */
    ...
    StarterPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"], _starter_routing_module__WEBPACK_IMPORTED_MODULE_4__["StarterPageRoutingModule"]],
      ...
      _createClass(StarterPage, [{
        ...
        value: function onLoginSuccess(accessToken, accessSecret) {
          ...
          this.authSVC.loginwithCredential(credential).then(function (success) {
            ...
            _this2.authSVC.user = success.user.email;
            _this2.authSVC.usersign = success.user;
            sessionStorage.setItem('user', JSON.stringify(_this2.authSVC.usersign)); //this.util.navCtrl.navigateForward("onBoarding");

            _this2.router.navigate(['/onBoarding']); //this.loading.dismiss();
        ...
        value: function obtenerTokenGoogle() {
          ...
          this.authSVC.obtenerToken().then(function (result) {
            ...
            if (result.user) {
              ...
              _this3.authSVC.user = result.user.email;
              _this3.authSVC.usersign = result.user;
              _this3.user = {
              ...
              _this3.authSVC.addUser(_this3.user);
            }

            console.log(_this3.authSVC.usersign);

            if (_this3.authSVC.user) {
              sessionStorage.setItem('user', JSON.stringify(_this3.authSVC.usersign)); //this.util.navCtrl.navigateForward("onBoarding");

              _this3.router.navigate(['/onBoarding']);
            } else {
              _this3.authSVC.usersign = JSON.parse(sessionStorage.getItem('user'));
              _this3.authSVC.user = _this3.authSVC.usersign.email;
