...
let DateTimePage = class DateTimePage {
    ...
    onSlotSelect(selectedTime) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.timeSlots.morning.forEach(element => {
                element.selected = false;
            });
            yield this.timeSlots.afternoon.forEach(element => {
                element.selected = false;
            });
            yield this.timeSlots.evening.forEach(element => {
                element.selected = false;
            });
            yield this.timeSlots.night.forEach(element => {
                element.selected = false;
            });
            selectedTime.selected = yield true;
        });
    }
    onDateSelect(selectedDate) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.date.forEach(element => {
                element.selected = false;
            });
            selectedDate.selected = yield true;
        });
    }
    goToPayment() {
...
DateTimePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./date-time.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/date-time/date-time.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./date-time.page.scss */ "./src/app/pages/date-time/date-time.page.scss")).default]
    }),
